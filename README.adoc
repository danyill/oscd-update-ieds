...
:uri-plugin: https://github.com/danyill/oscd-update-ieds
:uri-ci-bundle: https://danyill.github.io/oscd-update-ieds/oscd-update-ieds.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-update-ieds/index.deploy.html
...
// badges
image:https://github.com/danyill/oscd-update-ieds/actions/workflows/test.yml/badge.svg[title='Build Status']
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-update-ieds/dist/oscd-update-ieds.js`. 
...
<open-scd
  ...
  "editor": 
  [
    {"name": "Subscriber Later Binding", "translations": {"de": "Späte Bindung des Abonnenten", "pt": "Associação Tardia de Assinante"}, "icon": "link", "active": true, "requireDoc": true, "src": "/plugins/oscd-update-ieds/dist/oscd-update-ieds.js"}
  ]
}'
></open-scd>
----
